...
namespace Agent2
{
    ...
    {
        string connecting = @"Data Source=SYSTEM-BARCODE;Initial Catalog=bds_pp_srct;User ID=sa;Password=12345678"; //sql connection
        ...
        {
            string day = DateTime.Now.ToString("dd/MM/yy HH:mm:ss");
            using (SqlConnection conn = new SqlConnection(connecting))
            {
